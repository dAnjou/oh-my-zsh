...
plugins=(safe-paste environment terminal editor completion history directory spectrum alias utility prompt git command-not-found history-substring-search)
